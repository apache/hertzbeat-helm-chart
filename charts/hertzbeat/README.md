...
| **Database**                          |                                                                                                                                                                                                                 |                 |
| `database.timezone`                   | The database system timezone                                                                                                                                                                                    | `Asia/Shanghai` |
| `database.rootPassword`               | The database root user password                                                                                                                                                                                 | `123456`        |
...
| `database.persistence.size`           | The size of the volume                                                                                                                                                                                          | `4Gi`           |
...
| **External Database**                 |                                                                                                                                                                                                                 |                 |
| `database.external.host.value`        | External PostgreSQL host (direct value). Set to use external database.                                                                                                                                          | `""`            |
| `database.external.host.valueFrom`   | External PostgreSQL host via Secret. Use `valueFrom.secretKeyRef.name` and `key`.                                                                                                                              | `{}`             |
| `database.external.port.value`        | External PostgreSQL port (direct value).                                                                                                                                                                        | `5432`          |
| `database.external.port.valueFrom`   | External PostgreSQL port via Secret.                                                                                                                                                                           | `{}`             |
| `database.external.username.value`   | External PostgreSQL username (direct value).                                                                                                                                                                   | `root`          |
| `database.external.username.valueFrom` | External PostgreSQL username via Secret.                                                                                                                                                                       | `{}`             |
| `database.external.password.value`   | External PostgreSQL password (direct value).                                                                                                                                                                   | `""`            |
| `database.external.password.valueFrom` | External PostgreSQL password via Secret.                                                                                                                                                                      | `{}`             |
| `database.external.database.value`    | External PostgreSQL database name (direct value).                                                                                                                                                              | `hertzbeat`     |
| `database.external.database.valueFrom` | External PostgreSQL database name via Secret.                                                                                                                                                                  | `{}`             |
| **TSDB**                              |                                                                                                                                                                                                                 |                 |
| `tsdb.timezone`                       | The database system timezone                                                                                                                                                                                    | `Asia/Shanghai` |
...
| `tsdb.persistence.size`               | The size of the volume                                                                                                                                                                                          | `4Gi`           |
